        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="flex flex-col">
            ...
            <div className="mb-8">
              ...
              >
                Taille : <span className="text-[#B8955A] font-normal">{selectedVariant.title}</span>
              </p>
              <div className="flex flex-wrap gap-2.5">
                {product.variants.map((v) => (
                  <button
                    ...
                    className={`w-12 h-12 border text-[12px] transition-all duration-200 ${
            ...
            <button
              onClick={handleAdd}
              className="flex items-center justify-center gap-3 bg-[#1A1A18] text-[#F7F4EF] py-4.5 px-10 text-[11px] tracking-[0.2em] uppercase hover:bg-[#B8955A] transition-colors duration-300 mb-4 w-full"
